...
#
# Script generated by Vivado on Fri Feb 02 18:38:47 +0900 2024
...
# script info
echo -e "uart_fifo.sh - Script generated by export_simulation (Vivado v2023.2.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot uart_fifo xil_defaultlib.uart_fifo xil_defaultlib.glbl -log elaborate.log
}
